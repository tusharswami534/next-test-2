export const SLIDER_DATA = [
  {
    ...
    image: "/assets/image/png/first-image.png",
  },
  {
    heading: "Modernization Doesn’t Have to Mean Failure",
    description:
      "Traditional app modernization often falls short because teams are forced to navigate poorly documented legacy code — an outdated maze that slows progress and drives up costs. It’s time to change the narrative. <br/> <br/> The execution can neither compromise on business and technical requirements nor lose sight of modern architecture and security.",
    image: "/assets/image/png/second-image.png",
  },
  {
    heading: "Protected from Legal Risks and IP liability ",
    description:
    ...
    image: "/assets/image/png/third-image.png",
  },
  {
    heading: "AI generated apps need maintenance too!",
    description:
